public class RGB {
    ...
    static final public int MAX_VALUE = 1;
    public RGB () {
        this(1.0,1.0,1.0);
    }
    ...
    public boolean hasValueInRange(){
        return this.red <= RGB.MAX_VALUE && this.green <= RGB.MAX_VALUE && this.blue <= RGB.MAX_VALUE && this.red >= RGB.MIN_VALUE && this.green >= RGB.MIN_VALUE && this.blue >= RGB.MIN_VALUE;
    }
